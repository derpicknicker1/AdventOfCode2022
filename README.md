...
|:---|---:|---:|---:|---:|
| `benchmark\adv2.exe` | 5.3 ± 1.1 | 3.7 | 11.2 | 1.25 ± 0.31 |
| `benchmark\adv1.exe` | 4.9 ± 0.9 | 3.6 | 10.0 | 1.15 ± 0.27 |
| `benchmark\adv3.exe` | 4.4 ± 1.0 | 3.5 | 10.6 | 1.04 ± 0.28 |
| `benchmark\adv4.exe` | 4.3 ± 0.6 | 3.5 | 8.1 | 1.00 |
